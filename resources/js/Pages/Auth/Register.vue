...
<template>
    ...
    <section>
        <div
            class="min-h-full md:min-h-screen bg-gradient-to-tl from-indigo-100 to-indigo-100 w-full py-8 px-1 md:px-4"
        >
            <div
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div>
                            <TextInput
                                ...
                                class="bg-white-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-4"
                            />
                            <InputError
                                class="mt-2"
                        ...
                        <div class="text-center pt-2 lg:text-left">
                            <Link
                                :href="route('login')"
                                class="mt-2 mb-0 pt-1 text-sm font-semibold"
                            >
