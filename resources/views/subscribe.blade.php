                ...
                <div class="p-6">
                    ...
                    > 
                        ...
                        <div class="w-1/2 form-row">
                            ...
                            <div class="mt-4">
                                <input type="radio" name="plan" id="standard" value="price_1N2F4HEIptUzK9FMO1FUVDJd" checked>
                                <label for="standard">Standard - $10 / month</label> <br>

                                <input type="radio" name="plan" id="premium" value="price_1N2F4HEIptUzK9FMO1FUVDJd">
